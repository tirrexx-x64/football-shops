...
urlpatterns = [
    ...
    path("edit_product_flutter/<str:id>/", views.edit_product_flutter, name="edit_product_flutter"),
    path("delete_product_flutter/<str:id>/", views.delete_product_flutter, name="delete_product_flutter"),
